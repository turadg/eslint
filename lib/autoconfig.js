...
function makeRuleRegistry(rulesConfig) {
...
function Registry(rulesConfig) {
    this.rules = (rulesConfig) ? makeRuleRegistry(rulesConfig) : {};
}
...
Registry.prototype = {
    ...
    populateFromCoreRules: function() {
        ...
        this.rules = makeRuleRegistry(rulesConfig);
    },
    ...
    lintSourceCode: function(sourceCodes, config, cb) {
        ...
        lintedRegistry.stripUnlintedConfigs();
